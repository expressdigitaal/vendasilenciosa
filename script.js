...
// ============================================
// PROTEÇÃO ANTI-CLONAGEM (CARREGA DEPOIS DO SITE)
// ============================================
window.addEventListener('load', function() {
    ...
    // 2. Desabilitar teclas de atalho
    ...
    // 4. Console protegido
    console.log('%c🔒 SITE PROTEGIDO', 'color: #FFD700; font-size: 18px; font-weight: bold;');
    console.log('%c© 2025 Venda Silenciosa Start - Todos os direitos reservados', 'color: #fff; font-size: 11px;');
});
